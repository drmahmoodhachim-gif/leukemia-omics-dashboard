      ...
      <div className="space-y-6">
        <header>
          ...
          <p className="mt-2 text-muted-foreground">
            Automated pipeline pulling datasets from GEO, PRIDE, SRA microbiota studies, curated leukemia resources, and PubMed.
        ...
        {manifest ? (
          <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
            ...
            <dl className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Metric label="Microbiota studies" value={manifest.counts.microbiota} />
              <Metric label="Curated resources" value={manifest.counts.resources} />
              <Metric
        ...
        <section className="rounded-xl border border-border bg-card p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-4">
            ...
            <SourceRow
              ...
              description="Gut microbiome metagenomics and 16S studies in leukemia patients"
              schedule="Weekly"
              endpoint="src/lib/ingest/microbiota-ingest.ts"
            />
            <SourceRow
              name="Leukemia Resources"
              description="Curated atlases: TARGET, Beat AML, TCGA-LAML, AMLdb, MILE, scRNA-seq references"
              schedule="Weekly"
              endpoint="src/lib/ingest/leukemia-resources-ingest.ts"
            />
          </div>
        </section>
