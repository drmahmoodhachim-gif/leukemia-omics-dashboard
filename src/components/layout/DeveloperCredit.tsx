    ...
    return (
      <div className="space-y-2">
        <p className="text-xs text-muted-foreground">
          Curated public leukemia omics, microbiota, and reference atlases from GEO, PRIDE, SRA, and PubMed.
        </p>
      ...
      <div className="mt-3 flex items-start gap-4">
        ...
        <div>
          ...
          <p className="mt-3 text-sm leading-relaxed text-foreground/80">
            ...
            to leukemia and hematologic malignancy research resource curation, analysis, and
