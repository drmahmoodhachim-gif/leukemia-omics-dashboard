...
const EXAMPLE_QUESTIONS = [
  ...
  "Can gut microbiota predict chemotherapy toxicity in acute leukemia patients?",
  "What pathways are enriched in relapsed vs remission AML bone marrow?",
  "Which public datasets support FLT3-ITD biomarker discovery in AML?",
  "How does MRD molecular profiling compare to flow cytometry in ALL?",
];
          ...
          <div className="min-w-0 flex-1 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="e.g. We observed Enterococcus enrichment in newly diagnosed AML — which microbiota datasets support this and what validation is needed?"
