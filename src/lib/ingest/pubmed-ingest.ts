...
const QUERIES = [
  "acute myeloid leukemia omics",
  "acute lymphoblastic leukemia transcriptome",
  "chronic lymphocytic leukemia biomarker",
  "leukemia minimal residual disease",
  "AML single cell RNA-seq",
  "leukemia gut microbiota chemotherapy",
  "myelodysplastic syndrome genomics",
  "hematopoietic stem cell transplant microbiome",
];
